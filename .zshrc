...
# Wireguard stuff i.e. "h" = local network 
alias huw="sudo wg-quick up ~/.config/wireguard/nixos.conf"
alias hdw="sudo wg-quick down ~/.config/wireguard/nixos.conf"
alias ruw="sudo wg-quick up ~/.config/wireguard/nixos-away.conf"
alias rdw="sudo wg-quick down ~/.config/wireguard/nixos-away.conf"


# ssh stuff
alias box="ssh unnamed@nix" # Config in ~/.ssh/config
alias boxx="ssh -X unnamed@nix"

alias surface="ssh unnamed@surface" # Config in ~/.ssh/config
alias surfacei="ssh unnamed@surfacei" # Config in ~/.ssh/config


alias wbox='uw && ssh unnamed@nixi'
alias wboxx='uw && ssh -X unnamed@nixi'


# OpenClaw Completion (suppress stderr to avoid p10k instant prompt warning)
...
export PATH="/Users/unnamed/.local/bin:$PATH"
